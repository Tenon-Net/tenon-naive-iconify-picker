...
<p align="center">
  <img src="./assets/picker-hero.png" alt="IconPicker trigger" width="720">
</p>

<table>
  <tr>
    <td width="50%"><img src="./assets/picker-grid.png" alt="Icon grid — light"></td>
    <td width="50%"><img src="./assets/picker-dark.png" alt="Icon grid — dark"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="./assets/picker-tabs-ant.png" alt="Ant Design library tab"></td>
    <td width="50%"><img src="./assets/picker-local.png" alt="Local SVG tab"></td>
  </tr>
  <tr>
