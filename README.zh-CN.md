...
<p align="center">
  <img src="./assets/picker-hero.png" alt="IconPicker 触发器" width="720">
</p>

<table>
  <tr>
    <td width="50%"><img src="./assets/picker-grid.png" alt="图标网格 — 亮色"></td>
    <td width="50%"><img src="./assets/picker-dark.png" alt="图标网格 — 暗色"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="./assets/picker-tabs-ant.png" alt="Ant Design 库 Tab"></td>
    <td width="50%"><img src="./assets/picker-local.png" alt="本地 SVG Tab"></td>
  </tr>
  <tr>
